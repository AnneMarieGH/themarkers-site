...
export function PremiumGate() {
  return (
    <div className="relative my-8">
      ...
      <div className="border border-[#E8A020] rounded-sm p-8 text-center bg-[#FAFAF8]">
        <p className="text-[#E8A020] text-xs font-semibold uppercase tracking-widest mb-3">Members Only</p>
        ...
        <Link
          href="/membership"
          className="inline-flex items-center px-6 py-3 bg-[#E8A020] text-white font-semibold rounded-sm hover:bg-[#C8851A] transition-colors"
        >
          Become a Member →
        </Link>
      </div>
