      ...
      <article className="group relative overflow-hidden rounded-sm">
        {imageUrl && (
          <div className="relative aspect-[16/9] overflow-hidden">
            <Image src={imageUrl} alt={article.title} fill className="object-cover group-hover:scale-105 transition-transform duration-500" priority unoptimized />
    ...
    <article className="group flex flex-col">
      {imageUrl && (
        <div className="relative aspect-[3/2] overflow-hidden rounded-sm mb-4">
          <Image src={imageUrl} alt={article.title} fill className="object-cover group-hover:scale-105 transition-transform duration-300" unoptimized />
        </div>
      )}
